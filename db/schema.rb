...
ActiveRecord::Schema[8.0].define(version: 2025_09_03_170753) do
  ...
  create_table "album_songs", force: :cascade do |t|
    ...
    t.index ["album_id", "track_number"], name: "index_album_songs_on_album_id_and_track_number", unique: true
  ...
  create_table "songs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["filename"], name: "index_songs_on_filename", unique: true
  end
